...
var _listItem = require('list/list-item');
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      var result = this.lists.map(function (obj, i) {
...
var Styleguide = function (_React$Component) {
  ...
  function Styleguide(props) {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(Styleguide).call(this, props));
  }
...
Styleguide.propTypes = {
  ...
  example: _react2.default.PropTypes.node
};

exports.default = Styleguide;

},{"panel/panel":169,"react":158}],162:[function(require,module,exports){
'use strict';
  ...
  _createClass(Button, [{
    ...
    value: function componentDidMount() {
      ...
      this.refs.button.addEventListener('click', function () {
        _this2.refs.button.classList.add('ripple');
      });

      this.refs.button.addEventListener(_mixin2.default.whichTransitionEvent(), function () {
        _this2.refs.button.classList.remove('ripple');
      });
    }
  }, {
    key: 'render',
...
Button.styleguide = {
  ...
  example: _react2.default.createElement(
    'div',
    { className: 'example' },
    _react2.default.createElement(Button, { text: 'Default', link: '#' }),
    _react2.default.createElement(Button, {
      text: 'Rounded Primary',
      className: 'rounded primary',
      onClick: function onClick() {
        return alert('Button event!');
      }
    }),
    _react2.default.createElement(
      Button,
    ...
    _react2.default.createElement(Button, { text: 'Outlined Warning', className: 'outlined warning' })
  ),
...
},{"mixin":165,"react":158}],163:[function(require,module,exports){
'use strict';
...
var ListItem = function (_React$Component) {
  ...
  _createClass(ListItem, [{
    ...
    value: function componentDidMount() {
      ...
      this.refs.listItem.addEventListener('click', function () {
        _this2.refs.listItem.parentNode.childNodes.forEach(function (node) {
          node.classList.remove('selected');
        });
        _this2.refs.listItem.classList.add('selected');
      });
    }
  }, {
    key: 'render',
...
},{"list/list-item":163,"react":158}],165:[function(require,module,exports){
'use strict';
...
var Modal = function (_React$Component) {
  ...
  _createClass(Modal, [{
    key: 'buttonClick',
    value: function buttonClick(evt) {
      evt.preventDefault();
      this.modalOpen();
    }
  }, {
    ...
    value: function componentDidMount() {
      ...
      this.refs.modal.addEventListener('click', function () {
        _this2.modalClose();
      });
      ...
      this.refs.modalContent.addEventListener('click', function (evt) {
        evt.stopPropagation();
      });
    }
  }, {
...
exports.PanelFooter = exports.PanelHeader = exports.Panel = undefined;
...
var _panelHeader = require('panel/panel-header');

var _panelHeader2 = _interopRequireDefault(_panelHeader);

var _panelFooter = require('panel/panel-footer');
  ...
  _createClass(Panel, [{
    ...
    value: function renderHeader() {
      if (this.props.title !== undefined) {
        return _react2.default.createElement(_panelHeader2.default, {
          title: this.props.title,
...
Panel.propTypes = {
  title: _react2.default.PropTypes.string,
  titleClass: _react2.default.PropTypes.string,
  footer: _react2.default.PropTypes.node,
  footerClass: _react2.default.PropTypes.string,
  children: _react2.default.PropTypes.node,
  className: _react2.default.PropTypes.string
};
...
var Sticky = function (_React$Component) {
  ...
  function Sticky() {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(Sticky).apply(this, arguments));
  }

  _createClass(Sticky, [{
    key: 'activateSticky',
    value: function activateSticky() {
