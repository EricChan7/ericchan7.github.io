...
(function() {
  ...
  $(function() {
    $('#menu .refresh').click(function(evt) {
      var clock;
      evt.preventDefault();
      Clock.reset();
      clock = new Clock;
    ...
    $('#menu .finish').click(function(evt) {
      evt.preventDefault();
      return $('#menu').hide();
    });
    return Pressure.set('#clock', {
      end: function() {
        return $(this).css({
          transform: 'scale(1)'
        });
...
},{"clock":4,"jquery":1,"pressure":2}],4:[function(require,module,exports){
// Generated by CoffeeScript 1.10.0
(function() {
  var Clock, colorPool, rand, syms, updateClickInterval;
  ...
  updateClickInterval = void 0;

  Clock = (function() {
    function Clock() {
      var $dot, i, j, k, l, r, s;
      this.$clock = $('#clock');
      this.$hour = $('.hour', this.$clock);
      this.$minute = $('.minute', this.$clock);
      ...
      for (j = 1; j <= 3; j++) {
        $dot.clone().appendTo(this.$hour);
      }
      for (k = 1; k <= 5; k++) {
        $dot.clone().appendTo(this.$minute);
      }
      for (l = 1; l <= 7; l++) {
        $dot.clone().appendTo(this.$second);
      }
      this.$clock.show();
    ...
    Clock.reset = function() {
      ...
      $clock = $('#clock');
      $('.hour, .minute, .second', $clock).html('');
      $('.face span', $clock).remove();
      return $('.brand', $clock).html('<i class="d-hour"></i> <i class="semicolon">:</i> <i class="d-minute"></i>');
    };

    Clock.colorHand = function($elem) {
      return $.each($('.dot', $elem), function(i, v) {
        return $(v).css({
    ...
    Clock.prototype.colorHands = function() {
      Clock.colorHand(this.$hour);
      Clock.colorHand(this.$minute);
      return Clock.colorHand(this.$second);
    };

    Clock.updateHand = function($elem, x) {
    ...
    Clock.prototype.start = function() {
      ...
      updateClickInterval = setInterval(function() {
        return updateClock();
      }, 1000);
...
},{"velocity.min":5}],5:[function(require,module,exports){
