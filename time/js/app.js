...
(function() {
  var colorPool, enableNoSleep, enabledSleepLock, noSleep;
  ...
  $(function() {
    var $clock, $dot, $hour, $minute, $second, colorHand, colorHands, initFace, j, k, l, rand, updateClock, updateHand;
    $clock = $('#clock');
    ...
    $second = $('.second');
    for (j = 1; j <= 3; j++) {
      $dot.clone().appendTo($hour);
    }
    for (k = 1; k <= 5; k++) {
      $dot.clone().appendTo($minute);
    }
    for (l = 1; l <= 7; l++) {
      $dot.clone().appendTo($second);
    }
    $('body').click(function() {
      if (enabledSleepLock) {
        noSleep.disable();
    ...
    colorHands = function() {
      colorHand($hour);
      colorHand($minute);
      return colorHand($second);
    };
    updateHand = function($elem, x) {
      $elem.velocity({
        rotateZ: (x * 360) + "deg",
        translateY: '-100%',
        translateX: '-50%'
    ...
    updateClock = function() {
      ...
      return updateHand($hour, h / 24);
    };
    initFace = function() {
      var $face, $syms, i, r, s, syms;
      $face = $('.face');
      syms = {
        0: 'XII',
        1: '',
...
},{"jquery":1,"nosleep":3,"velocity.min":4}],3:[function(require,module,exports){
/**
