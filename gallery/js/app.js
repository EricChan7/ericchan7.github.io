      ...
      value: function componentWillMount() {
        ...
        this.fetchImage().then(function () {
          setInterval(function () {
            _this3.setState({ showImage: !_this3.state.showImage });
            if (_this3.images.length <= 1) {
              _this3.fetchImage();
            }
          }, 5000);
        }, function (e) {
...
},{"image":161,"jquery":2,"lib/getImage":162,"react":159,"react-dom":3}],161:[function(require,module,exports){
'use strict';
...
var Image = function (_React$Component) {
  ...
  function Image(props) {
    ...
    _this.getImage = new _getImage2.default();
  ...
  _createClass(Image, [{
    ...
    value: function componentDidMount() {
      ...
      $(_reactDom2.default.findDOMNode(this)).on('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function () {
        if (!_this2.props.state) {
          _this2.setState({ image: _this2.props.image });
        }
      });
    }
  }, {
